...
Next we want to convert the two functions into density functions (meaning that areas under the curves should sum to one). This is one way to normalize measurements of different organisms so they are comparible. In this example, I'm doing this numerically to avoid a nasty integral. This works well unless the areas under the curve are really small.
